...
$sql="INSERT INTO user (uname, pass, utype, name, address, mobile, mail, memtype, adtime, deleted, block)
VALUES('$user','$pass','$utype','$name','$address','$mobile','$mail','One Time',NOW(),'N','N')";
echo $id;
...
//  alert('Invoice Created Sucessfully Invoice No:- ' )
 //window.location = 'rcomp.php';
 
  //echo $a;
  //
  echo "<b>Customer Created Sucessfully........! </b><br><br>";
 $cname;
//$pack=$_POST['package'];
$sql="select * from user where name='$cname'";
...
$ans=mysql_query($sql);
   while($row=mysql_fetch_array($ans))
   {
	...
	echo"The Member:- <b>". $name . "</b>  Member No Is:-<b> ".$no."</b><br><br>";
