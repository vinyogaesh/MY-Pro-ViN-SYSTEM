...
include_once 'conf.vani';
//$del=$_POST['delname'];
mysql_query("UPDATE upload SET block='Y' where id='".$_REQUEST['blkfile']."'");
mysql_close($con);
  ?>
 <table align="center" border="0">
<?php  echo "<br><b>Article Blocked Sucessfully........! </b><br><br>";
  echo"Article Id is:-<b>".$_REQUEST['blkfile']."</b>";
