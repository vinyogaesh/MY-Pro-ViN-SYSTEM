											...
											<div class="art-post">
												<div class="art-post-body">
													<div class="art-post-inner art-article">
														<p align="left"><b>Welcome <?php echo $_SESSION['username']; ?></b></p>										<h2 class="art-postheader">Manage Files</h2>
														<div class="art-postcontent">
															
							<strong><a href="delfile.php"><b>Delete File</b></a></strong>&nbsp;&nbsp;&nbsp;<strong><a href="retfile.php"><b>Retrive File</b></a></strong>&nbsp;&nbsp;&nbsp;<strong><a href="blckfile.php"><b>Block File</b></a></strong>&nbsp;&nbsp;&nbsp;<strong><a href="unblckfile.php"><b>Un Block File</b></a></strong>
    <h2 class="art-postheader" align="center">File Details</h2>
	<table>
  <form action="unblckdfile.php" method="post">
<?php

echo"<tr><th>Title</th><th>Added By</th><th>Select</th><th>Un Block</th>";

include_once("conf.vani");

$sql="select * from upload WHERE deleted='N' and block='Y' ";
$ans=mysql_query($sql);
while($row=mysql_fetch_array($ans))
   {?>
   
   <tr><td><?php echo $row['title']; ?></td><td><?php echo $row['createdby'];?></td><td><input type="radio" name="unblckfile" value="<?php echo $row[id]; ?>"></td><td><input type="submit" name="blk" value="Un Block"></td></tr>
