...
<tr><th>Member Name</th><th>Member Autorization</th><th>Block</th></tr>
<?php
   ...
   while($row=mysql_fetch_array($ans))
{
  ...
  // $status=$row['status'];
   ?>
<form action="blkmem.php" method="post">
  
<tr><td><?php echo $uname;?></td><td><?php 
if($utype=='2')
 {
	 echo "Admin";
 }
 ...
 {
	 echo"Member";
 }?></td><td><input  type="hidden" name="blkname" value="<?php echo $id; ?>"/><input type="submit" name="unblk" value="Block" /></td></tr>
</form>
<?php }
mysql_close($con)
?>
