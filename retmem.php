...
<tr><th>Member No</th><th>Member Name</th><th>Retrive</th></tr>
<?php


	$sql="Select * from user WHERE deleted='Y' ";
   ...
   while($row=mysql_fetch_array($ans))
{
   ...
   ?>
<form action="retdmem.php" method="post">
  
<tr><td><?php echo $memno;?></td><td><?php echo $memname;?></td><td><input  type="hidden" name="retname" value="<?php echo $memno; ?>"/><input type="submit" name="ret" value="Retrive" /></td></tr>
</form>
<?php }
mysql_close($con)
?>
