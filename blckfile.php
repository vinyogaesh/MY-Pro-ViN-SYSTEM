...
<a href="#" title="Android Developer"><img src="data1/tooltips/outofspaceandroid.jpg" alt="Android Developer"/>5</a></div>
	...
	<table>
  <form action="blckdfile.php" method="post">
<?php

echo"<tr><th>Title</th><th>Added By</th><th>Select</th><th>Block</th>";

include_once("conf.vani");

$sql="select * from upload WHERE deleted='N' and block='N' ";
$ans=mysql_query($sql);
while($row=mysql_fetch_array($ans))
   {?>
   
   <tr><td><?php echo $row['title']; ?></td><td><?php echo $row['createdby'];?></td><td><input type="radio" name="blkfile" value="<?php echo $row[id]; ?>"></td><td><input type="submit" name="blk" value="Block"></td></tr>
