	...
	<script type="text/javascript" src="engine1/script.js"></script>
								...
								<div class="art-nav">
									...
									<ul class="art-menu">
										...
										<li><a href="memmanage.php" ><span class="l"> </span><span class="r"> </span><span class="t">Members Manage</span></a></li>
											...
											<div class="art-post">
												<div class="art-post-body">
													<div class="art-post-inner art-article">
														<p align="left"><b>Welcome <?php echo $_SESSION['username']; ?></b></p><p align="right"><a href="#" onClick="MyWindow=window.open('updatepass.php','MyWindow','toolbar=no,location=no,directories=no,status=no, menubar=no,scrollbars=no,resizable=no,width=600,height=800,');
             if (MyWindow)
			 {
                MyWindow.focus(5);
        	 }
         return false;">Change Password</a></p>
														<h2 class="art-postheader">Create New Content</h2>
...
include 'conf.vani';
$query = "INSERT INTO upload (abstract,createdby,posttime,deleted,title,name, size, type, content,block ) ".
"VALUES ('$abstract','$createdby',NOW(),'$deleted','$title','$fileName', '$fileSize', '$fileType', '$content','$block')";
$qr=mysql_query($query) or die('Error Creating Content, query failed'); 

$sql = "SELECT id FROM upload WHERE name='$fileName'";
...
if($qr)
{
	$query1 = "INSERT INTO banner_clicks (id,url,clicks) VALUES ('$stvalue','download.php?id=$stvalue','1')";
mysql_query($query1) or die('Error Creating Content Banner, query failed');  	
}
}
}
echo "<br>Your Document Named:- $fileName Sucessfully Uploaded<br>";
echo '<META HTTP-EQUIV="Refresh" Content="2; URL=user_landing.php">';    
exit;  
} 
?>
