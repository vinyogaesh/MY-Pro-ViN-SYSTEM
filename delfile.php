...
<table>											
<form action="deldfile.php" method="post">
<?php

echo"<tr><th>Title</th><th>Added By</th><th>Select</th><th>Delete</th>";
...
while($row=mysql_fetch_array($ans))
   ...
   <tr><td><?php echo $row['title']; ?></td><td><?php echo $row['createdby'];?></td><td><input type="radio" name="delfile" value="<?php echo $row[id]; ?>"></td><td><input type="submit" name="del" value="Delete"></td></tr>
