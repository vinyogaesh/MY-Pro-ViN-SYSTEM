...
$cmpno=$_POST['memno'];
$stat=$_POST['memname'];
$note=$_POST['memaddress'];
$servpri=$_POST['memmobno'];
$servengname=$_POST['memmail'];
$memtype=$_POST['memtype'];
$utype=$_POST['utype'];
$sql="UPDATE user SET utype='$utype',name='$stat',address='$note',mobile='$servpri',mail='$servengname',memtype='$memtype' WHERE id='$cmpno'";
...
<?php  echo "<b>member Updated Sucessfully........! </b><br><br>";
  echo"member No is:-<b>".$cmpno."</b>";
