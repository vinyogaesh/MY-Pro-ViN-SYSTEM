...
<tr><th>Member No</th><th>Member Name</th><th>Member Address</th><th>Member Mobile</th><th>Member Mail-ID</th><th>Member Type</th><th>Status</th></tr>
<?php
   ...
   while($row=mysql_fetch_array($ans))
{
   ...
   if($row['block']=='N')
  {
   ...
   ?>
<tr><td><?php echo $memno;?></td><td><?php echo $memname;?></td><td><?php echo $memaddress;?></td><td><?php echo $memmob;?></td><td><?php echo $memmail;?></td><td><?php echo $memtype;?></td><td><?php echo $status;?></td></tr>
...
<br /><br /><br />
<a href="user_landing.php">Back</a>
