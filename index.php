										...
										<div class="art-layout-cell art-content">
											<div class="art-post">
												<div class="art-post-body">
													...
													<p align="right"><a href="signup.php">Create Account</a></p>
														<h2 class="art-postheader">Login</h2>
														<div class="art-postcontent">
			
			        <form action="login.php" method="post">
<p align="center"> Username :-<input type="text" name="username"  autofocus="on"/></p>
<p align="center"> Password :-<input type="password" name="password" autocomplete="off"  /></p>
<p align="center"> Login:-<select name="log" ><option value="">--------Select--------</option>
<option value="admLogin">Admin Login</option>
<option value="usrLogin" selected="true">User Login</option>
</select></p>
<p align="center"><input type="submit" name="sub" value="Login" /></p></br>
</form>
