...
<tr><th>User Name</th><th>User Type</th><th>Un Block</th></tr>
<?php
	$sql="Select * from user WHERE deleted='N' and block='Y'";
$ans=mysql_query($sql);
   while($row=mysql_fetch_array($ans))
{
  ...
  // $status=$row['status'];
?>
<form action="unblkmem.php" method="post">
<tr><td><?php echo $uname;?></td><td><?php if($utype=='2')
 {
	 echo "Admin";
	 }
	 else
	 {
		 echo"Member";
	 }?></td><td><input  type="hidden" name="unblkname" value="<?php echo $id; ?>"/><input type="submit" name="unblk" value="Unblock" /></td></tr>
</form>
<?php }
mysql_close($con)
?>
