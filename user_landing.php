...
<tr><td>Enter Abstract About Content,Keywords and etc.,</td><td><textarea name="abstract" rows="5" cols="45"></textarea></td></tr>
<tr>
<td></td><td><input name="upload" type="submit" class="box" id="upload" value=" Upload "></td></tr>
</table>
</form>
