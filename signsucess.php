...
VALUES('$user','$pass','10','$name','$address','$mobile','$mail','One Time',NOW(),'N','N')";
echo $id;
if (!mysql_query($sql,$con))
  {
  die('Error: ' . mysql_error());
  }
  echo "<b>Your Account Created Sucessfully........! </b><br><br>";
 $cname;
//$pack=$_POST['package'];
...
$ans=mysql_query($sql);
   while($row=mysql_fetch_array($ans))
   {
	$no=$row['id'];
	$name = $row['uname'];
		echo"User Name:- <b>". $name . "</b>  Member ID Is:-<b> ".$no."</b><br><br>";
