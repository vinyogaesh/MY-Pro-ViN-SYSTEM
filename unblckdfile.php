...
<a href="#" title="Android Developer"><img src="data1/tooltips/outofspaceandroid.jpg" alt="Android Developer"/>5</a></div>
    ...
    <h2 class="art-postheader" align="center">Files Details</h2>
...
include_once 'conf.vani';
//$del=$_POST['delname'];
mysql_query("UPDATE upload SET block='N' where id='".$_REQUEST['unblckfile']."'");
mysql_close($con);
  ?>
 <table align="center" border="0">
<?php  echo "<br><b>Article Un Blocked Sucessfully........! </b><br><br>";
  echo"Article Id is:-<b>".$_REQUEST['unblckfile']."</b>";
  echo("<script type='text/javascript'>
                    window.setTimeout(function() {
                        location.href = 'ctrl_file.php';
                    }, 1000);
        </script>");
