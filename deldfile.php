...
include_once 'conf.vani';
//$del=$_POST['delname'];
mysql_query("UPDATE upload SET deleted='Y' where id='".$_REQUEST['delfile']."'");
mysql_close($con);
  ?>
 <table align="center" border="0">
<?php  echo "<b>Article Deleted Sucessfully........! </b><br><br>";
  echo"Article Id is:-<b>".$_REQUEST['delfile']."</b>";
